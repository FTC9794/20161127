 ...
 */
@Autonomous(group = "auto", name = "Auto Red Slide and Shoot")
public class AutonomousRedSlideAndShoot extends LinearVisionOpMode {
    ...
    Object[][] sequenceArray = new Object[][]{
            ...
            {stateMachine.slideState, 0, .5, 1, 4200, 0.0, 0.01},
            {stateMachine.slideState, 270, 1.0, 2, -1000.0, 0.0, 0.0005},
            {stateMachine.shootParticle,.325},
            {stateMachine.slideState, 270, 1.0, 2, -1000.0, 0.0, 0.005},
            {stateMachine.stop},
    };

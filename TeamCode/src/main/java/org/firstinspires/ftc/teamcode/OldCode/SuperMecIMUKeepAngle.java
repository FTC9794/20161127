...
import org.firstinspires.ftc.teamcode.OldCode.PushCapBallSequencerIMUInit;
...
public class SuperMecIMUKeepAngle extends OpMode {
    DcMotor rf;
    DcMotor rb;
    DcMotor lf;
    DcMotor lb;
    ...
    double offset = PushCapBallSequencerIMUInit.endGyro;
    @Override
    public void init() {
        ...
        telemetry.addData("End Gyro", offset);
    }

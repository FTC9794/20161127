...
@TeleOp(group = "Mecanum Drive", name = "TeleOp All Lefty Flip")
public class LinearTeleOpAllLeftyFlip extends LinearOpMode{
    DcMotor rf;
    DcMotor rb;
    DcMotor lf;
    DcMotor lb;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        File gyroFile = AppUtil.getInstance().getSettingsFile(gyroFileName);
        ...
        while(opModeIsActive()){
            if(gamepad1.dpad_up){
                ...
                ReadWriteFile.writeFile(gyroFile, String.valueOf(angle));

 ...
 */
@TeleOp(group = "Open CV", name = "New Beacon Test")
public class ManualVisionSample extends ManualVisionOpMode {
    ...
    public void loop() {
        ...
        if(colorAnalysis.isLeftBlue()){
            telemetry.addData("color", "blue");
        }else if(colorAnalysis.isLeftRed()){
            telemetry.addData("color", "red");
        }else if(!colorAnalysis.isLeftKnown()){
            telemetry.addData("color", "unknown");
        }else{
            telemetry.addData("color", "Weird case");
        }
    ...
    public Mat frame(Mat rgba, Mat gray) {
        try {
            ...
            Beacon beacon = new Beacon(Beacon.AnalysisMethod.VVAnalysis);
            ...
            colorAnalysis = beacon.analyzeFrame(detectorRed, detectorBlue, rgba, gray,
                    orientation);
        } catch (Exception e) {
            e.printStackTrace();
        }
